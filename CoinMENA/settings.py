...
# SECRET_KEY = 'django-insecure-t)nl8d01i!@mnx==&!$5ke9%&idihys#81ufy@u#xzzxm994nu'
...
MIDDLEWARE = [
    ...
    'CoinMENA.middlewares.VerifyTokenMiddleware',
]
...
DATABASES = {
    'default': {
        ...
        'USER': os.environ.get("USER", default='db_user'),
        'PASSWORD': os.environ.get("PASSWORD", default='db_password'),
